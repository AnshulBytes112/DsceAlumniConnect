...
import { GraduationCap, LayoutDashboard, User, Users, LogOut, LogIn, UserPlus, Bell, Settings, Calendar, ShieldCheck ,Briefcase, MessageSquare,Image, BarChart3, Globe} from 'lucide-react';
...
export default function GlobalNavbar() {
  ...
  const tabs = isAuthenticated ? [
    ...
    { title: 'Forums', icon: MessageSquare, href: '/dashboard/forums' },
